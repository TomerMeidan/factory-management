...
const deleteEmployeeByID = async (id) => {
  ...
  if (employee === null){
    console.log(`EmployeesBLL: deleteEmployeeByID: The employee (id: ${id}) doesn't exist in the system!`)
    return `The employee (id: ${id}) doesn't exist in the system!`;
  }
  await employeeModel.deleteOne({ _id: id });
  console.log(`EmployeesBLL: deleteEmployeeByID: The employee (id: ${id}) is deleted from the system!`)
...
const updateEmployeeByID = async (id, data) => {
  ...
  const response = await employeeModel
    ...
    .catch((err) => {
      console.log(`EmployeeBLL: updateEmployeeByID: Error updating employee's (id: ${id}) information in the system! errorMEssage:${err.message}`);
...
const addEmployee = async (employeeData) => {
  ...
  try {
    ...
    console.log(`EmployeeBLL: addEmployee: Error finding given department by user, errorMessage:${err.message}`);
  ...
  try {
    ...
    console.log(`EmployeeBLL: addEmployee: Failed Adding new employee! errMessage:${err.message}`)
